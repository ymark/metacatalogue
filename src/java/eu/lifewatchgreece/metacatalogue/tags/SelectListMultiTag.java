 ...
 * @author Alexandros
 */
public class SelectListMultiTag extends SimpleTagSupport {
    ...
    public void doTag() throws IOException, JspException{
        ...
        String html = "<div class='col-md-"+this.dLen+"'>"
                        ...
                        + "var oldValue = $('#"+this.fName+"').val().trim();"
                        + "var newValue = $(this).attr('data-value');"
                        + "if(oldValue.length > 0){"
                        + "$('#"+this.fName+"').val(oldValue+','+newValue).change();"
                        + "} else {"
                        + "$('#"+this.fName+"').val(newValue).change();"
                        + "}"
                        + "});"
                        + "</script>";
