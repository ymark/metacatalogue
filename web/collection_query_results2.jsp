                ...
                <nav>
                    <ul class="pagination">
                        <li <c:if test = "${!leftArrow}">class='disabled'</c:if> >
                            <a href="${baseUrl}/search/directory?datasetName=${searchName}&institution=${institution}&creator=${creator}&datasetType=${datasetType}&location=${location}&taxonomicCoverage=${taxonomicCoverage}&dateCoverageFrom=${dateCoverageFrom}&dateCoverageTo=${dateCoverageTo}&page=${page-1}" aria-label="Previous">
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>     
                                    <c:if test = "${loop.index <= lastPage}">
                                        <li><a href="${baseUrl}/search/directory?datasetName=${searchName}&institution=${institution}&creator=${creator}&datasetType=${datasetType}&location=${location}&taxonomicCoverage=${taxonomicCoverage}&dateCoverageFrom=${dateCoverageFrom}&dateCoverageTo=${dateCoverageTo}&page=${loop.index}">${loop.index}</a></li>
                                    </c:if>                                                                      
                                </c:otherwise>
                            </c:choose>                        
                        </c:forEach>
                        <c:if test = "${rightArrow}">
                            <li>
                                <a href="${baseUrl}/search/directory?datasetName=${searchName}&institution=${institution}&creator=${creator}&datasetType=${datasetType}&location=${location}&taxonomicCoverage=${taxonomicCoverage}&dateCoverageFrom=${dateCoverageFrom}&dateCoverageTo=${dateCoverageTo}&page=${page+1}" aria-label="Next">
