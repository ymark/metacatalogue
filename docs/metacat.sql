...
INSERT INTO `settings` (`id`, `name`, `value`, `last_modified`, `about`) VALUES
	...
	(16, 'virtuosoUrl', 'http://23.3.2.123/', '2015-05-03 12:00:00', 'Virtuoso URL'),
	(17, 'virtuosoPort', '1112', '2015-05-03 12:00:00', 'Virtuoso Port'),
	(18, 'virtuosoJdbc', 'jdbc:virtuoso://23.3.2.123:1112', '2015-05-03 12:00:00', 'Virtuoso IP-Port'),
	(19, 'virtuosoUser', 'vuser', '2015-05-03 12:00:00', 'Virtuoso Username'),
	(20, 'virtuosoPass', 'vuserpwd', '2015-05-03 12:00:00', 'Virtuoso Password'),
	(21, 'directoryGraph', 'http://MyDirectoryService', '2015-05-03 12:00:00', 'Directory Graph'),
	(22, 'metadataGraph', 'http://MyMetadataRepository', '2015-05-03 12:00:00', 'Metadata Graph'),
	(23, 'uriPrefix', 'http://www.myproject.eu/entity', '2015-05-03 12:00:00', 'URI Prefix'),
